...
export default function Home() {
  ...
  /////*****/////
  return (
    <div className={styles.heroContainer} ref={hero}>
      <div className={styles.hero}>
        <div className={`${styles.herosection}`}>
          <Image alt="A photo of Destiny" src={photo} width={300} id='image'/>
          <p id='intro'>Hi there I am Destiny a software developer and designer.</p>
        </div>
        <div className={`${styles.herosection} ${styles.textLeft}`} id='herotext'>
      ...
      <Contentcontainer
        content={`Hello, welcome to my other self, my name is Destiny and I design and develop websites.
                  ...
                  and developing intuitive and friendly user experiences on the web. I do that with passion. I make 
